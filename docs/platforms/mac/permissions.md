...
- Same path: run the app from a fixed location (for Skynet, `dist/Skynet.app`).
...
Workaround: move files into the Skynet workspace (`~/.skynet/workspace`) if you want to avoid per-folder grants.
