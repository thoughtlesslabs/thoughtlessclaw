---
summary: "Use NVIDIA's OpenAI-compatible API in Skynet"
read_when:
  - You want to use NVIDIA models in Skynet
...
skynet onboard --auth-choice skip
skynet models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
