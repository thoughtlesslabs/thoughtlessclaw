---
summary: "Use Qianfan's unified API to access many models in Skynet"
read_when:
...
3. Skynet installed on your system
...
4. Copy the API key for use with Skynet

## CLI setup

```bash
skynet onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Skynet Configuration](/gateway/configuration)
