---
summary: "Use Qwen OAuth (free tier) in Skynet"
read_when:
  - You want to use Qwen with Skynet
...
If you already logged in with the Qwen Code CLI, Skynet will sync credentials
