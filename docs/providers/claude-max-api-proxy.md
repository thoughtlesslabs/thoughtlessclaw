...
You can point Skynet at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Skynet
...
- [Anthropic provider](/providers/anthropic) - Native Skynet integration with Claude setup-token or API keys
