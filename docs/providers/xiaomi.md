---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Skynet"
read_when:
  - You want Xiaomi MiMo models in Skynet
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Skynet uses
