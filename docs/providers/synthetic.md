---
summary: "Use Synthetic's Anthropic-compatible API in Skynet"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Skynet registers it as the
...
Note: Skynet's Anthropic client appends `/v1` to the base URL, so use
