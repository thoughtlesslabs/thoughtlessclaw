...
本指南总结了在 Skynet 中开发 Pi 集成的合理工作流程。
...
状态存储在 Skynet 状态目录下。默认为 `~/.skynet`。如果设置了 `SKYNET_STATE_DIR`，则使用该目录。
...
- https://docs.skynet.ai/testing
- https://docs.skynet.ai/start/getting-started
