...
Skynet treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.skynet/settings/voicewake.json`

Shape:

```json
{ "triggers": ["skynet", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
