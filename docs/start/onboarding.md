---
summary: "First-run onboarding flow for Skynet (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Skynet">
...
<Step title="CLI">
  ...
  The app can install the global `skynet` CLI via npm/pnpm so terminal
