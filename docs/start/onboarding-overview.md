---
summary: "Overview of Skynet onboarding options and flows"
read_when:
...
Skynet supports multiple onboarding paths depending on where the Gateway runs
...
- [`skynet onboard` command](/cli/onboard)

## macOS app onboarding

Use the Skynet app when you want a fully guided setup on macOS. Docs:
