...
Skynet treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams.

## Beginner intro (2 minutes)

Skynet “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, Skynet can see that group and respond there.
...
Translation: allowlisted senders can trigger Skynet by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@skynet", "skynet", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
