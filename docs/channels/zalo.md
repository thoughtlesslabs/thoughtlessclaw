...
- Install via CLI: `skynet plugins install @skynet/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `skynet plugins install ./extensions/zalo`
   - From npm (if published): `skynet plugins install @skynet/zalo`
...
- Approve via:
  - `skynet pairing list zalo`
  - `skynet pairing approve zalo <CODE>`
...
- Example: `skynet message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `skynet channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `skynet logs --follow`
