...
Skynet ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Skynet also aligns
the install method:
...
When you switch channels with `skynet update`, Skynet also syncs plugin sources:
