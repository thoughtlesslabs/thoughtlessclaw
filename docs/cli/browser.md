---
summary: "CLI reference for `skynet browser` (profiles, tabs, actions, extension relay)"
read_when:
  - You use `skynet browser` and want examples for common tasks
...
Manage Skynet’s browser control server and run browser actions (tabs, snapshots, screenshots, navigation, clicks, typing).
...
- `skynet`: launches/attaches to a dedicated Skynet-managed Chrome instance (isolated user data dir).
