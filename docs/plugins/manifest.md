...
read_when:
  - You are building a Skynet plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (skynet.plugin.json)

Every plugin **must** ship a `skynet.plugin.json` file in the **plugin root**.
Skynet uses this manifest to validate configuration **without executing plugin
