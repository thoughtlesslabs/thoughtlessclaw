...
show_usage() {
    cat << EOF
clawlog - Skynet Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Skynet logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Skynet logs flow through the macOS unified log (subsystem: ai.skynet).
