...
- Keep product names in English: Skynet, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Skynet Gateway, use “Gateway 网关”.
