...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "skynet", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for Skynet. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("Skynet Issue Label Audit");
