...
docker run --rm -t \
  ...
  -e SKYNET_LIVE_GATEWAY_MODELS="${SKYNET_LIVE_GATEWAY_MODELS:-${CLAWDBOT_LIVE_GATEWAY_MODELS:-all}}" \
  -e SKYNET_LIVE_GATEWAY_PROVIDERS="${SKYNET_LIVE_GATEWAY_PROVIDERS:-${CLAWDBOT_LIVE_GATEWAY_PROVIDERS:-}}" \
  -e SKYNET_LIVE_GATEWAY_MODEL_TIMEOUT_MS="${SKYNET_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-${CLAWDBOT_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-}}" \
