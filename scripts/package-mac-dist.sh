...
# Output:
# - dist/Skynet.app
# - dist/Skynet-<version>.zip
# - dist/Skynet-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.skynet.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/Skynet.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Skynet-$VERSION.zip"
DMG="$ROOT_DIR/dist/Skynet-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Skynet-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Skynet-$VERSION.dSYM.zip"
