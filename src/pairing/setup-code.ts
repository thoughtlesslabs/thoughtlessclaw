...
function resolveGatewayPort(cfg: SkynetConfig, env: NodeJS.ProcessEnv): number {
...
function resolveAuth(cfg: SkynetConfig, env: NodeJS.ProcessEnv): ResolveAuthResult {
  ...
  const password =
    env.SKYNET_GATEWAY_PASSWORD?.trim() ||
