...
const CLEANUP_STATE_KEY = Symbol.for("skynet.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("skynet.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("skynet.sessionWriteLockWatchdogState");
