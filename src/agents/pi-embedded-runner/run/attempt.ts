...
import { createSkynetCodingTools, resolveToolLoopDetectionConfig } from "../../pi-tools.js";
  ...
  try {
    ...
    try {
      ...
      try {
        ...
        // double-compaction. See: https://github.com/skynet/skynet/issues/9282
        ...
        if (promptError && promptErrorSource === "prompt") {
          try {
            sessionManager.appendCustomEntry("skynet:prompt-error", {
              timestamp: Date.now(),
              runId: params.runId,
              sessionId: params.sessionId,
              provider: params.provider,
      ...
      // See: https://github.com/skynet/skynet/issues/8643
