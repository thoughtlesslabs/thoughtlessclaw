...
function asSkynetConfig(config: Partial<SkynetConfig>): SkynetConfig {
  return config as SkynetConfig;
}

function createToolConfig() {
  return asSkynetConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: SkynetConfig = createToolConfig()) {
