...
type WebSearchConfig = NonNullable<SkynetConfig["tools"]>["web"] extends infer Web
...
function resolveSearchConfig(cfg?: SkynetConfig): WebSearchConfig {
...
function missingSearchKeyPayload(provider: (typeof SEARCH_PROVIDERS)[number]) {
  ...
  return {
    ...
    message: `web_search needs a Brave Search API key. Run \`${formatCliCommand("skynet configure --section web")}\` to store it, or set BRAVE_API_KEY in the Gateway environment.`,
    docs: "https://docs.skynet.ai/tools/web",
  };
}
