...
function resolveWatchPaths(workspaceDir: string, config?: SkynetConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: SkynetConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: SkynetConfig }) {
