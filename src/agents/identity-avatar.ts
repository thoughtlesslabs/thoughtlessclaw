...
function resolveAvatarSource(cfg: SkynetConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: SkynetConfig, agentId: string): AgentAvatarResolution {
