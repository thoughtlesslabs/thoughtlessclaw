...
function resolveAdaptiveReadMaxBytes(options?: SkynetReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createSkynetReadTool(base, {
...
export function createSkynetReadTool(
  base: AnyAgentTool,
  options?: SkynetReadToolOptions,
): AnyAgentTool {
