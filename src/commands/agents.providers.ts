...
function resolveDefaultAccountId(cfg: SkynetConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: SkynetConfig): boolean {
...
export function summarizeBindings(cfg: SkynetConfig, bindings: AgentBinding[]): string[] {
