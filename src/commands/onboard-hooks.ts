...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.skynet.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("skynet hooks list")}`,
      `  ${formatCliCommand("skynet hooks enable <name>")}`,
      `  ${formatCliCommand("skynet hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
