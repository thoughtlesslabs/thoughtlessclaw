...
export function applyVercelAiGatewayProviderConfig(cfg: SkynetConfig): SkynetConfig {
...
export function applyVercelAiGatewayConfig(cfg: SkynetConfig): SkynetConfig {
