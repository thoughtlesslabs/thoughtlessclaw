...
// Prefix for Skynet-generated action IDs to scope our handler
const SKYNET_ACTION_PREFIX = "skynet:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  const modalMatcher = new RegExp(`^${SKYNET_ACTION_PREFIX}`);

  // Handle Skynet modal submissions with callback_ids scoped by our prefix.
