...
function mergeSlackAccountConfig(cfg: SkynetConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: SkynetConfig): ResolvedSlackAccount[] {
