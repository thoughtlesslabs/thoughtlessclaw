...
function resolveMentionPatterns(cfg: SkynetConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: SkynetConfig | undefined, agentId?: string): RegExp[] {
