...
describe("setupOnboardingShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("skynet");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "skynet");
