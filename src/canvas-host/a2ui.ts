...
export const A2UI_PATH = "/__skynet__/a2ui";

export const CANVAS_HOST_PATH = "/__skynet__/canvas";

export const CANVAS_WS_PATH = "/__skynet__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.skynetCanvasA2UIAction.postMessage(...)
  // - Android: window.skynetCanvasA2UIAction.postMessage(...)
  const handlerNames = ["skynetCanvasA2UIAction"];
  ...
  globalThis.Skynet = globalThis.Skynet ?? {};
  globalThis.Skynet.postMessage = postToNode;
  globalThis.Skynet.sendUserAction = sendUserAction;
  globalThis.skynetPostMessage = postToNode;
  globalThis.skynetSendUserAction = sendUserAction;
