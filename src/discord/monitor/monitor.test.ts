...
describe("agent components", () => {
  const createCfg = (): SkynetConfig => ({}) as SkynetConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/skynet-sessions-test.json");
  });
