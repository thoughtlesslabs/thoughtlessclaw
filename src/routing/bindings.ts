...
export function listBindings(cfg: SkynetConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: SkynetConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: SkynetConfig) {
