...
const SANDBOX_EXAMPLES = {
  main: [
    ["skynet sandbox list", "List all sandbox containers."],
    ["skynet sandbox list --browser", "List only browser containers."],
    ["skynet sandbox recreate --all", "Recreate all containers."],
    ["skynet sandbox recreate --session main", "Recreate a specific session."],
    ["skynet sandbox recreate --agent mybot", "Recreate agent containers."],
    ["skynet sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["skynet sandbox list", "List all sandbox containers."],
    ["skynet sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["skynet sandbox recreate --all", "Recreate all containers."],
    ["skynet sandbox recreate --session main", "Recreate a specific session."],
    ["skynet sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["skynet sandbox recreate --browser --all", "Recreate only browser containers."],
    ["skynet sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["skynet sandbox explain", "Show effective sandbox config."],
    ["skynet sandbox explain --session agent:main:main", "Explain a specific session."],
    ["skynet sandbox explain --agent work", "Explain an agent sandbox."],
    ["skynet sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.skynet.ai/cli/sandbox")}\n`,
    )
    .action(() => {
