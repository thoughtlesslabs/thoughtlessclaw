...
function resolveAnthropicDefaultAuthMode(cfg: SkynetConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: SkynetConfig): SkynetConfig {
...
export function applyTalkApiKey(config: SkynetConfig): SkynetConfig {
...
export function applyTalkConfigNormalization(config: SkynetConfig): SkynetConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: SkynetConfig): SkynetConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: SkynetConfig): SkynetConfig {
...
export function applyLoggingDefaults(cfg: SkynetConfig): SkynetConfig {
...
export function applyContextPruningDefaults(cfg: SkynetConfig): SkynetConfig {
...
export function applyCompactionDefaults(cfg: SkynetConfig): SkynetConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
