...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/skynet/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/skynet/extensions",
        global: "/Users/x/.skynet/extensions",
        workspace: "/Users/x/ws/.skynet/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.skynet/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/skynet/extensions",
        global: "/Users/x/.skynet/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.skynet/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/skynet/extensions",
        global: "/Users/x/.skynet/extensions",
