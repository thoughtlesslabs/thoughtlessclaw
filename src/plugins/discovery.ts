...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @skynet/voice-call -> voice-call).
...
export function discoverSkynetPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ownershipUid?: number | null;
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".skynet", "extensions")];
