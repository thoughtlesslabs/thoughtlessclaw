...
export type SkynetPluginConfigSchema = {
...
export type SkynetPluginToolContext = {
  config?: SkynetConfig;
  workspaceDir?: string;
  agentDir?: string;
  agentId?: string;
...
export type SkynetPluginToolFactory = (
  ctx: SkynetPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type SkynetPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type SkynetPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<SkynetConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type SkynetPluginGatewayMethod = {
  method: string;
 ...
 */
export type SkynetPluginCommandDefinition = {
...
export type SkynetPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type SkynetPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type SkynetPluginCliContext = {
  program: Command;
  config: SkynetConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type SkynetPluginCliRegistrar = (ctx: SkynetPluginCliContext) => void | Promise<void>;

export type SkynetPluginServiceContext = {
  config: SkynetConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type SkynetPluginService = {
  id: string;
  start: (ctx: SkynetPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: SkynetPluginServiceContext) => void | Promise<void>;
};

export type SkynetPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type SkynetPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: SkynetPluginConfigSchema;
  register?: (api: SkynetPluginApi) => void | Promise<void>;
  activate?: (api: SkynetPluginApi) => void | Promise<void>;
};

export type SkynetPluginModule =
  | SkynetPluginDefinition
  | ((api: SkynetPluginApi) => void | Promise<void>);

export type SkynetPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | SkynetPluginToolFactory,
    opts?: SkynetPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: SkynetPluginHookOptions,
  ) => void;
  registerHttpHandler: (handler: SkynetPluginHttpHandler) => void;
  registerHttpRoute: (params: { path: string; handler: SkynetPluginHttpRouteHandler }) => void;
  registerChannel: (registration: SkynetPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: SkynetPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: SkynetPluginService) => void;
   ...
   */
  registerCommand: (command: SkynetPluginCommandDefinition) => void;
