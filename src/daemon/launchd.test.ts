...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.skynet.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", SKYNET_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.skynet.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when SKYNET_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.skynet.gateway.plist",
    },
    {
      name: "uses profile-specific label when SKYNET_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", SKYNET_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.skynet.jbphoenix.plist",
    },
    {
      name: "prefers SKYNET_LAUNCHD_LABEL over SKYNET_PROFILE",
      env: {
        HOME: "/Users/test",
        SKYNET_PROFILE: "jbphoenix",
        SKYNET_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from SKYNET_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        SKYNET_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty SKYNET_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        SKYNET_PROFILE: "myprofile",
        SKYNET_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.skynet.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
