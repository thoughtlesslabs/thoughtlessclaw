...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.SKYNET_STATE_DIR;
  const configPath = env.SKYNET_CONFIG_PATH;
  ...
  return {
    ...
    SKYNET_PROFILE: profile,
    SKYNET_STATE_DIR: stateDir,
    SKYNET_CONFIG_PATH: configPath,
    SKYNET_GATEWAY_PORT: String(port),
    SKYNET_GATEWAY_TOKEN: token,
    SKYNET_LAUNCHD_LABEL: resolvedLaunchdLabel,
    SKYNET_SYSTEMD_UNIT: systemdUnit,
    SKYNET_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    SKYNET_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    SKYNET_STATE_DIR: stateDir,
    SKYNET_CONFIG_PATH: configPath,
    SKYNET_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    SKYNET_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    SKYNET_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    SKYNET_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    SKYNET_LOG_PREFIX: "node",
    SKYNET_SERVICE_MARKER: NODE_SERVICE_MARKER,
    SKYNET_SERVICE_KIND: NODE_SERVICE_KIND,
    SKYNET_SERVICE_VERSION: VERSION,
  };
}
