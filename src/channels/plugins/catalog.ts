...
import { discoverSkynetPlugins } from "../../plugins/discovery.js";
import type { SkynetPackageManifest } from "../../plugins/manifest.js";
...
const ENV_CATALOG_PATHS = ["SKYNET_PLUGIN_CATALOG_PATHS", "SKYNET_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<SkynetPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: SkynetPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: SkynetPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverSkynetPlugins({ workspaceDir: options.workspaceDir });
