...
export function listChannelMessageActions(cfg: SkynetConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: SkynetConfig): boolean {
...
export function supportsChannelMessageCards(cfg: SkynetConfig): boolean {
