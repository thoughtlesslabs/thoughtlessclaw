...
function mergeSignalAccountConfig(cfg: SkynetConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: SkynetConfig): ResolvedSignalAccount[] {
