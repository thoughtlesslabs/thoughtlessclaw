...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.SKYNET_TTS_PREFS;
      process.env.SKYNET_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.SKYNET_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: SkynetConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
