...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof SkynetConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: SkynetConfig; env: NodeJS.ProcessEnv }): {
  cfg: SkynetConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
