...
export function listMattermostAccountIds(cfg: SkynetConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: SkynetConfig): string {
...
export function listEnabledMattermostAccounts(cfg: SkynetConfig): ResolvedMattermostAccount[] {
