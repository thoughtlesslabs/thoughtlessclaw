...
export function listZalouserAccountIds(cfg: SkynetConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: SkynetConfig): string {
...
function mergeZalouserAccountConfig(cfg: SkynetConfig, accountId: string): ZalouserAccountConfig {
