...
This directory contains the **BlueBubbles external channel plugin** for Skynet.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `skynet/plugin-sdk` helpers.
