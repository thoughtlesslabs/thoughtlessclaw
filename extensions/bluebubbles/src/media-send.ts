...
import { resolveChannelMediaMaxBytes, type SkynetConfig } from "skynet/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: SkynetConfig; accountId?: string }): string[] {
