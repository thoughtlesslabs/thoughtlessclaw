...
export function listBlueBubblesAccountIds(cfg: SkynetConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: SkynetConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: SkynetConfig): ResolvedBlueBubblesAccount[] {
