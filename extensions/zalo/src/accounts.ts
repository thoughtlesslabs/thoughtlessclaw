...
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "skynet/plugin-sdk/account-id";
...
export function listZaloAccountIds(cfg: SkynetConfig): string[] {
...
export function resolveDefaultZaloAccountId(cfg: SkynetConfig): string {
...
function mergeZaloAccountConfig(cfg: SkynetConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: SkynetConfig): ResolvedZaloAccount[] {
