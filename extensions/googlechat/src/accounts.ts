...
export function listGoogleChatAccountIds(cfg: SkynetConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: SkynetConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: SkynetConfig): ResolvedGoogleChatAccount[] {
