...
import type { ReplyPayload, SkynetConfig } from "skynet/plugin-sdk";
import { createReplyPrefixOptions } from "skynet/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as SkynetConfig;
