...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "skynet/plugin-sdk";
...
import { resolvePreferredSkynetTmpDir } from "../../../src/infra/tmp-skynet-dir.js";
import {
  type MSTeamsAdapter,
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredSkynetTmpDir(), "msteams-mention-"));
