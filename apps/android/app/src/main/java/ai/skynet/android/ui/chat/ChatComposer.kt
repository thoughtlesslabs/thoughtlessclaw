...
import ai.skynet.android.ui.mobileSurface
import ai.skynet.android.ui.mobileText
import ai.skynet.android.ui.mobileTextSecondary
import ai.skynet.android.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.skynet.android.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.skynet.android.ui.mobileFontFamily,
