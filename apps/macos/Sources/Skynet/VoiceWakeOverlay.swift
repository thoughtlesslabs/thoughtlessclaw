...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.skynet", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Skynet windows, but below the system’s pop-up menus.
