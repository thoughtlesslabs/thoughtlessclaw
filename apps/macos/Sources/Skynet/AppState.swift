...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = SkynetConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = SkynetConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = SkynetConfigFile.loadDict()
            ...
            SkynetConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/skynet"
        state.remoteCliPath = ""
        return state
    }
}
