...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.skynet", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".skynet/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.skynetCommand(
            subcommand: "gateway",
