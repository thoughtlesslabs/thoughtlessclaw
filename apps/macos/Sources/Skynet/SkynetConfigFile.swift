...
enum SkynetConfigFile {
    private static let logger = Logger(subsystem: "ai.skynet", category: "config")
    ...
    static func stateDirURL() -> URL {
        SkynetPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        SkynetPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-skynet-config-file",
            "event": "config.write",
