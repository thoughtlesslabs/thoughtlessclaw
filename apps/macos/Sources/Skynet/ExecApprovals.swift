...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.skynet", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        SkynetPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        SkynetPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
