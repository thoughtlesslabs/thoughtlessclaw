...
enum UIStrings {
    static let welcomeTitle = "Welcome to Skynet"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "skynet.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: SkynetOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: SkynetChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g skynet@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: SkynetChatViewModel(
