...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/skynet/skynet") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/skynet/skynet")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://skynet.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "SkynetBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "SkynetBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "SkynetGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "SkynetGitCommit") as? String) ??
            "unknown"
    }
