...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .skynetSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? SkynetPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? SkynetPaths.stateDirURL.path
...
extension Notification.Name {
    static let skynetSelectSettingsTab = Notification.Name("skynetSelectSettingsTab")
}
