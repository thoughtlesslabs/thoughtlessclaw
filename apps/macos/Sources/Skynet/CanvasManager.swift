...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.skynet", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Skynet/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__skynet__/a2ui/").absoluteString + "?platform=macos"
    }
