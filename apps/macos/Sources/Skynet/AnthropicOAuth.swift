...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (Skynet token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: SkynetOAuthStore.AnthropicOAuthStatus = SkynetOAuthStore
...
enum AnthropicOAuth {
    private static let logger = Logger(subsystem: "ai.skynet", category: "anthropic-oauth")
...
enum SkynetOAuthStore {
    static let oauthFilename = "oauth.json"
    private static let providerKey = "anthropic"
    private static let skynetOAuthDirEnv = "SKYNET_OAUTH_DIR"
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "Skynet OAuth token file not found"
            case .unreadableFile: "Skynet OAuth token file not readable"
            case .invalidJSON: "Skynet OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in Skynet OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "Skynet OAuth credentials found"
            }
        }
    }

    static func oauthDir() -> URL {
        if let override = ProcessInfo.processInfo.environment[self.skynetOAuthDirEnv]?
        ...
        return home.appendingPathComponent(".skynet", isDirectory: true)
