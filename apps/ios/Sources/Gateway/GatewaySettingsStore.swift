...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.skynet.gateway"
    private static let nodeService = "ai.skynet.node"
    private static let talkService = "ai.skynet.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.skynet.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.skynet.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("skynet-gateway.log")
    }
