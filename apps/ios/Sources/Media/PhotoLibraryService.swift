...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: SkynetPhotosLatestParams) async throws -> SkynetPhotosLatestPayload {
        ...
        var results: [SkynetPhotoPayload] = []
        ...
        return SkynetPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> SkynetPhotoPayload
    {
