...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.skynet", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.skynet", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: SkynetProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
