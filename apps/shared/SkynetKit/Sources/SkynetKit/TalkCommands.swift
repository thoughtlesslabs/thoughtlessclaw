...
public enum SkynetTalkCommand: String, Codable, Sendable {
...
public struct SkynetTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct SkynetTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
