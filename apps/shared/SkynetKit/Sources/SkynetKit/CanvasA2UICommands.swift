...
public enum SkynetCanvasA2UICommand: String, Codable, Sendable {
...
public struct SkynetCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct SkynetCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
