...
@MainActor
public struct SkynetChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: SkynetChatViewModel
    ...
    private var visibleMessages: [SkynetChatMessage] {
        let base: [SkynetChatMessage]
    ...
    private func mergeToolResults(in messages: [SkynetChatMessage]) -> [SkynetChatMessage] {
    ...
    private func isToolResultMessage(_ message: SkynetChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: SkynetChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: SkynetChatMessage) -> String {
