...
public typealias SkynetPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias SkynetPlatformImage = UIImage
#endif

public struct SkynetChatUsageCost: Codable, Hashable, Sendable {
...
public struct SkynetChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: SkynetChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(SkynetChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct SkynetChatMessageContent: Codable, Hashable, Sendable {
...
public struct SkynetChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [SkynetChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: SkynetChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [SkynetChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: SkynetChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(SkynetChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([SkynetChatMessageContent].self, forKey: .content) {
...
public struct SkynetChatHistoryPayload: Codable, Sendable {
...
public struct SkynetSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct SkynetSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [SkynetSessionPreviewItem]
}

public struct SkynetSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [SkynetSessionPreviewEntry]

    public init(ts: Int, previews: [SkynetSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct SkynetChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct SkynetChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct SkynetAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct SkynetChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct SkynetGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct SkynetPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: SkynetPlatformImage?
...
public struct SkynetChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
