...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = SkynetChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = SkynetChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
